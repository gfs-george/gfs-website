    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="disclosure">
          ...
          <p>Securities and investment advisory services offered through <strong className="osaic-name">Osaic Wealth, Inc.</strong>, Member <a href="https://www.finra.org" target="_blank" rel="noreferrer">FINRA</a>/<a href="https://www.sipc.org" target="_blank" rel="noreferrer">SIPC</a>. <strong className="osaic-name">Osaic Wealth</strong> is separately owned and other entities and/or marketing names, products or services referenced here are independent of <strong className="osaic-name">Osaic Wealth</strong>. <strong className="osaic-name">Osaic Wealth</strong> does not offer tax or legal advice.</p>
